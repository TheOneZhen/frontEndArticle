...
1. 定制化业务线与Arch
    ...
    Arch技术栈沿用MDesign4，没有什么新的技术突破。但是在建设过程中，发现它的功能复用程度很大，与定制化业务契合，所以俩个业务线合并。
...
2. 自研图形引擎Design Graph
    
    历史问题：Mdesign3使用MXGraph，图形扩展难度大、性能低、框架体积大、与业务绑定太深导致跨平台难度大
    
    Design Graph是独立组件，支持跨平台。内部将Vue3响应式和svg集合，并向外导出graph类，实现图形统一控制。
...
5. JEST（https://github.yanhaixiang.com/jest-tutorial/basic/test-environment/#jsdom-%E6%B5%8B%E8%AF%95%E7%8E%AF%E5%A2%83）
...
个人主要技术栈Vue3，接触过全栈开发，上一份工作中接触过Electron和Nestjs。业余时间学习过Python Django，并使用其建设个人网站。
